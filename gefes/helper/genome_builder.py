...
class GenomeBuilder(object):
    ...
    def __init__(self,parent):
        self.parent = parent
        self.bini = parent
        self.fwds=[str(p.cleaner.fwd.path) for p in self.bini.parent.parent.parent]
        self.revs=[str(p.cleaner.rev.path) for p in self.bini.parent.parent.parent]
        # Auto paths #
